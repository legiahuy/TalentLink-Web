                                                    ...
                                                    {filteredArtists.length > 0 && (
                                                        <section>
                                                            <div className="flex items-center gap-2 mb-4">
                                                                ...
                                                                <span className="text-sm text-muted-foreground ml-2">({filteredArtists.length})</span>
                                                            </div>
                                                            <motion.div
                                                    ...
                                                    {filteredVenues.length > 0 && (
                                                        <section>
                                                            <div className="flex items-center gap-2 mb-4">
                                                                ...
                                                                <span className="text-sm text-muted-foreground ml-2">({filteredVenues.length})</span>
                                                            </div>
                                                            <motion.div
