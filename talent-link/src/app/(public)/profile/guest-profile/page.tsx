...
import { MapPin, Star, Music, Mail, ExternalLink, MoreHorizontal } from 'lucide-react'
        ...
        <div className="px-6 md:px-8">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pb-12">
                  ...
                  <Card className="bg-card border-border/40">
                    <CardContent className="p-6">
                      <div className="space-y-4 text-muted-foreground">
                        <p>
                          Xin chào! Tôi là Minh Anh, một ca sĩ đam mê với dòng nhạc pop và ballad
                          Việt Nam. Với giọng hát trữ tình và khả năng diễn đạt cảm xúc sâu sắc, tôi
                          luôn mong muốn mang đến những trải nghiệm âm nhạc đáng nhớ cho khán giả.
                        </p>
                        <p>
                          Tôi có kinh nghiệm biểu diễn tại các sự kiện như đám cưới, tiệc công ty,
                          và các buổi hòa nhạc nhỏ. Ngoài ra, tôi cũng có thể hỗ trợ thu âm vocal và
                          dạy thanh nhạc cho những bạn muốn phát triển kỹ năng ca hát.
                        </p>
                        <p>
              ...
              {/* Events full-width below both columns */}
              <div className="lg:col-span-3">
                <section>
                  <h2 className="text-2xl font-semibold mb-4">Sự kiện đã biểu diễn</h2>
                  ...
                  <div className="w-full flex justify-center mt-4">
                    <Button variant="default">Hiện tất cả</Button>
                  </div>
                </section>
              </div>
            </div>
